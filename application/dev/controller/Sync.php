...
class Sync extends Controller
{
     ...
     */
    public function index($channel='default',$currentPage = 1, $pageSize = 100)
    {
        $data = Synchronous::field([])->where("channel",$channel)->order('create_time', 'desc')->paginate(['list_rows' => $pageSize, 'page' => $currentPage]);
